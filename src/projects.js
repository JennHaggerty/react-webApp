      ...
      if(e === 'delete') {
        projects.forEach((_project, index) => {
          if(_project.id === project.id) {
            ...
            projectsPromise = axios.delete('http://localhost:3001/projects', {
        ...
        projectsPromise = axios.post('http://localhost:3001/project',
          [newprojects], {
          headers: {'Authorization': localStorage.token}
        })
        .then(serverResponse => {
        ...
        projectsPromise = axios.post('http://localhost:3001/projects',
          projects, {
          headers: {'Authorization': localStorage.token}
        })
      }  
          ...
          { editView 
            ...
            : <div>
                ...
                <h2> Latest Project</h2><br/>
                  ...
                  <div id="allProjects" className="row match-my-cols">
                  {
                        ...
                        <div key={index}>
                          <div className="panel panel-default col-md-4">
                            ...
                            <div className="panel-body"> 
                              ...
                              <div className="panel-footer"><i>Logged: {project.date} | Tags: {project.tags} </i></div>
                            </div>
                          </div>
                        </div>
                      );
